...
export function CodeBracketIcon({ className = "w-6 h-6" }: IconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
...
export function CircleStackIcon({ className = "w-6 h-6" }: IconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
...
export function CubeIcon({ className = "w-6 h-6" }: IconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
